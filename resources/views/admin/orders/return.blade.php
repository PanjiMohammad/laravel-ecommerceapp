                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td class="refund">{{ $order->return->refund_transfer }}</td>
                                        </tr>
                                        <tr>
                                            <th>Status</th>
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            let refund = '{{ $order->return->refund_transfer }}';
            console.log(refund)
            const formatRefund = new Intl.NumberFormat("id-ID", {style: "currency", currency: "IDR"}).format(refund)
