                                    ...
                                    <div class="col-md-12">
                                        <div class="row float-right">
                                            <div class="form-group mr-1">
                                                <input type="text" id="search" name="search" class="form-control" placeholder="Cari..." value="{{ request()->search }}">
                                            </div>
                                            <div class="form-group mr-1">
                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form onsubmit="return confirm('Yakin Hapus Kategori ?')" action="{{ route('category.destroy', $cat->id) }}" method="post">
                                                        <!-- KONVERSI DARI @ CSRF & @ METHOD AKAN DIJELASKAN DIBAWAH -->
                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="{{ route('category.edit', $cat->id) }}" class="btn btn-warning btn-sm"><span class="fas fa-pen"></span></a>
