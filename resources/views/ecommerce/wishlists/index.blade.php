                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('/products/' . $row->product->image) }}" width="100px" height="100px" alt="{{ $row->product->image }} ">
                                                </td>
                                                ...
                                                <td>
                                                    <form action="{{ route('customer.deleteWishlist', $row->id) }}" onsubmit="return confirm('Kamu Yakin Menghapus Produk ini dari Daftar Wishlist ?');" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="{{ url('/product/'. $row->product->slug) }}" class="btn btn-primary btn-sm mr-1"><span class="fa fa-eye"></span></a>
