                ...
                <div class="col-lg-9">
                    ...
                    <div class="latest_product_inner row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6">
                            <div class="f_p_item">
                                <div class="f_p_img" style="height: 100px; width: 200px;">
                                    <img class="img-fluid rounded mh-100 mx-auto d-block"  src="{{ asset('/products/' . $row->image) }}" alt="{{ $row->name }}">
                                    <div class="p_icon">
                                ...
                                <ul class="list">
                                    ...
                                    <li>
                                        ...
                                        <ul class="list" style="display: block">
                                            <li>
                                                <a href="{{ url('/category/' . $child->slug) }}" class="font-weight-bold">{{ $child->name }}</a>
                                            </li>
                                        </ul>
                                        @endforeach
                                    </li>
