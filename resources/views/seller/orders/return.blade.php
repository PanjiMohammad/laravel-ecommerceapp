            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Detail Pesanan (Return)</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td class="refund">{{ $totalReturn }}</td>
                                        </tr>
                                        <tr>
                                            <th>Status</th>
                                    ...
                                    <form action="{{ route('orders.new_approve_return') }}" onsubmit="return confirm('Kamu Yakin ?');" method="post">
                                        @csrf
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset('/proof/return/' . $order->return->photo) }}" class="img-responsive" height="200" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            let refund = '{{ $totalReturn }}';
            console.log(refund)
            const formatRefund = new Intl.NumberFormat("id-ID", {
                style: "currency", 
                currency: "IDR", 
                maximumSignificantDigits: "3"
            }).format(refund)
            $('.refund').text(formatRefund)
