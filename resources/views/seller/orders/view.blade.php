                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    ...
                                    <a href="{{ route('orders.new_approve_payment', $order->invoice) }}" class="btn btn-primary btn-sm">Terima Pembayaran</a>
                                    @endif
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($order->status == 2)
                                                    <form action="{{ route('orders.newShipping') }}" method="post">
                                                        @csrf
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $row->weight }} gram</td>
                                            </tr>
                                            @endforeach
                                            <tr>
                                                <td class="text-center font-weight-bold">Subtotal</td>
                                                <td colspan="3" class="text-center font-weight-bold subtotal">{{ $subtotal }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" class="text-center font-weight-bold total"><b>{{ $total }}</b></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            var total = '{{ $total }}'
            console.log('Ini Total baru = ' + total)
