...
@section('content')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="float-left">
                                ...
                                <a href="{{ route('product.newCreate') }}" class="btn btn-primary">Tambah</a>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <img src="{{ asset('/products/' . $row->image) }}" width="150px" height="125px" alt="{{ $row->name }}">
                                            </td>
                                            <td>
 ...
 -->
                                            <td>
                                                ...
                                                <form onsubmit="return confirm('Yakin Hapus Produk ?')" action="{{ route('product.newDestroy', $row->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{ route('product.newEdit', $row->id) }}" class="btn btn-warning btn-sm"><span class="fas fa-pen"></span></a>
