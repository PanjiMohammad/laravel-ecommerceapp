                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('report.newOrder') }}" method="get">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><strong class="text-uppercase">{{ $row->invoice }}</strong></td>
                                            <td>
                                                <label><strong>{{ $row->customer_name }}</strong></label>
                                                <br>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#exportpdf').attr('href', '/seller/reports/reportorder/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))
            ...
            $('#created_at').daterangepicker({
                ...
                $('#exportpdf').attr('href', '/seller/reports/reportorder/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
            })
        })
    </script>
@endsection