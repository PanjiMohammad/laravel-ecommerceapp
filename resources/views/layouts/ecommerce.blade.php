				...
				<div class="float-right">
					<ul class="right_side">
						@if (auth()->guard('customer')->check())
							...
							<li><a href="{{ route('customer.logout') }}">Keluar</a></li>
						@else
							<li><a href="{{ route('customer.login') }}">Masuk</a></li>
							<li><a href="{{ route('customer.register') }}">Registrasi</a></li>
						@endif
						<li><a href="https://api.whatsapp.com/send?phone=087889165715&text=Halo%20Admin">Hubungi Kami</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container-fluid">
                    ...
                    <a class="navbar-brand logo_h" href="{{ url('/') }}">
						<img src="{{ asset('ecommerce/img/pasar-jaya-2.png') }}" style="height: 70px; width: 120px;" alt="">
					</a>
			...
			<div class="row">
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget">
						...
						<p class="text-justify">Perumda Pasar Jaya adalah Badan Usaha Milik Daerah (BUMD) yang bergerak dalam bidang usaha pengelola pasar, properti, dan pengembangan bisnis dengan kepemilikan saham sepenuhnya oleh Pemerintah Provinsi DKI Jakarta.</p>
					</div>
				</div>
